...
require_once("../../data/classes/constants.php");
    ...
    if(isset($_POST["submitButton"])) { // Si el botón Enviar es presionado, entonces...
        ...
        if($success) {
            echo '<script language="javascript">alert("Se ha registrado y suscrito exitosamente. ¡Bienvenid@ a Carlevix '.$username.'! \n\nDisfrute de nuestro mes gratis de obsequio");window.location.href="../profile/selectProfile.php"</script>';
            ...
            <div class = "container">
                ...
                <div class = "dataForm">
                    ...
                    <div class = "buttonOmitir">
                        <div class = "marginbuttonChangePlan">
